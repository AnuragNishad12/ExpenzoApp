...
class Transaction30daysAdapter(private val transactionList: List<FetchOtherCurrentDataResponse30days>) :
    RecyclerView.Adapter<Transaction30daysAdapter.TransactionViewHolder>() {
